...
<body class="bg-slate-900 min-h-screen flex flex-col justify-between p-4 font-sans text-slate-800">
  ...
  <script>
    ...
    function mudarAba(aba) {
      document.getElementById("abaCadastro").style.display = (aba === "cad" ? "block" : "none");
      document.getElementById("abaLista").style.display = (aba === "list" ? "block" : "none");
      document.getElementById("abaAcessos").style.display = (aba === "acc" ? "block" : "none");
      document.getElementById("abaLogs").style.display = (aba === "logs" ? "block" : "none");
    ...
    function salvarMembro() {
      ...
      .then(function(data) {
        if (data.success) {
          ...
          document.getElementById("resCadastro").style.display = "block";
          fotoBase64 = "";
